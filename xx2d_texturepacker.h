...
namespace xx {
    ...
    struct TexturePacker : Frames {
        ...
        int Load(Data_r dr, std::string_view const& plistUrl_) {
            frames.clear();
            premultiplyAlpha = {};
            ...
            for (size_t i = 0; i < numFrames; ++i) {
                ...
                if (int r = dr.Read((RWFloatInt16&)f->spriteOffset.x, (RWFloatInt16&)f->spriteOffset.y)) return r;
                if (int r = dr.Read((RWFloatUInt16&)f->spriteSize.x, (RWFloatUInt16&)f->spriteSize.y)) return r;
                if (int r = dr.Read((RWFloatUInt16&)f->spriteSourceSize.x, (RWFloatUInt16&)f->spriteSourceSize.y)) return r;
